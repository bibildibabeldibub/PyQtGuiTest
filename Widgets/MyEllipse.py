...
class MyEllipse(QGraphicsEllipseItem):
    ...
    def itemChange(self, change, value):
        """
        Bewegungsverhalten: Verhindern von ineinanderlaufenden Spielern
        :param change: was wird verändert
        :param value: wie wird es verändert
        :return: Postion bei ItemMove
        """
        ...
        if change == QGraphicsItem.ItemPositionChange:
            ...
            if filtered_colliding_items:
                ...
                if type(self.spieler) == Player.offensePlayer:
                    for i in filtered_colliding_items:
                        if type(i.spieler) is Player.defensePlayer:
